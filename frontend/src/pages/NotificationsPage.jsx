...
const NotificationsPage = () => {
  ...
  const renderRelatedPost = (relatedPost) => {
    ...
    return (
      ...
      >
        {relatedPost.image && (
          <img src={getMediaUrl(relatedPost.image)} alt='Post preview' className='w-10 h-10 object-cover rounded' />
        )}
                  ...
                  <div className='flex items-start justify-between'>
                    <div className='flex items-start space-x-4'>
                      <Link to={`/profile/${notification.relatedUser.username}`}>
                        <img
                          src={getMediaUrl(notification.relatedUser.profilePicture) || "/avatar.png"}
                      ...
                      <div className='flex-1'>
                        <div className='flex items-center gap-2 mb-2'>
                          <div className='p-2 bg-gray-100 rounded-full'>{renderNotificationIcon(notification.type)}</div>
